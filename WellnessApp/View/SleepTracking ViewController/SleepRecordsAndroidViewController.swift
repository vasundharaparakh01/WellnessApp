//
//  SleepRecordsAndroidViewController.swift
//  Luvo
//
...
class SleepRecordsAndroidViewController: UIViewController {
    //Custom Navbar
...
//    var timeObserver: Any?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(SleepRecordsAndroidViewController.setupNotificationBadge),
...
//        barChartView.chartDescription.enabled = false
        ...
        barChartView.maxVisibleCount = 1
...
//            self.lblEndTime.text    = ""
        ...
        debugPrint(dateTimeToTime(sleepAt))
        debugPrint(dateTimeToTime(wakeAt))
        
//        self.lblSleepAt.text        = ""
//        self.lblWakeAt.text         = ""
...
extension SleepRecordsAndroidViewController: LineChartDelegate {
...
extension SleepRecordsAndroidViewController {
...
extension SleepRecordsAndroidViewController: SleepStatDelegate {
...
extension SleepRecordsAndroidViewController: ChartViewDelegate {
